...
Lorsqu'on lance le binaire, un mot de passe est attendu.

On peut désassembler le binaire. Seul une fonction _main_ est présente :
...
A partir de ce code et à l'aide de gdb, on peut réécrire en C le code source :
...
On comprend très facilement qu'il faut passer la valeur 5276 sur l'entrée standard pour pouvoir lancer un shell avec les droits du propriétaire du binaire.
